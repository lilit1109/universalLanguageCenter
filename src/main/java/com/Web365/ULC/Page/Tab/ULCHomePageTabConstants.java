...
public class ULCHomePageTabConstants {
	public static final String HOME_PAGE_UNIKIDS_XPATH ="//div//a[@href='/Home/English' and text()='Show more']";
	...
	public static final String RUSSIAN_LANGUAGE_IMAGE_XPATH ="//img[@src='/img/iconn4.jpg']";
