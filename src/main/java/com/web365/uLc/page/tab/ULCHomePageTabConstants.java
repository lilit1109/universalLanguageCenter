...
public class ULCHomePageTabConstants {
	...
	public static final String SIGNIN_ERROR_TRY_AGAIN_BATTON_XPATH = "//div[@class='o6cuMc']";
	public static final String SIGNIN_PAGE_CREATE_ACCOUNT_BATTON_XPATH = "//span[@jsname='V67aGc' and text() = 'Create account']";
	...
	public static final String RUSSIAN_LANGUAGE_IMAGE_XPATH = "//img[@src='/img/iconn4.jpg' and @class='img-fluid']";
	public static final String RUSSIAN_LANGUAGE_INFORM_XPATH="//div[@class='courses-text']//h5[text() = 'Russian']";
	public static final String YOUNG_LERNERS_PROGRAM_XPATH = "//strong[text()='Young Learners English Program Highlights']";
	public static final String LANGUAGES_PAGE_XPATH = "//div[@class='container pencil_edit']//h2[text()='Languages ']";
	public static final String UNIKIDS_PROGRAM_PAGE_IMAGE_XPATH = "//img[@src='/img/ulc_gallery25.jpg']";
	public static final String INT_EXAM_PAGE_IMAGE_XPATH = "//div[@class='cont-animation']//a[@href='/Home/Examin']";
